...
bot_token = os.environ.get("TOKEN","5681957815:AAFhFXCA5TzZChgvqtk2Ef8QV17ObX-k4ZU")
BOT_ID = os.environ.get("BOT_ID",5740066159)
OWNER_ID = os.environ.get("OWNER_ID",5508658149)
